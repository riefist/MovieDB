...
data class MovieDetailResponse(
    ...
    fun toEntity() : MovieEntity {
        val entity = MovieEntity(id, title, overview, BASE_IMAGE_URL + posterPath, BASE_IMAGE_URL + backdropPath)
        entity.genres = genres.map { it.name }
        entity.rating = voteAverage
